...
async function main() {
  console.log("🧹 Iniciando limpeza do ambiente de teste...");
  ...
  // 1. Deletar por ID e por Tag (mais seguro)
  ...
  console.log(`🗑️  Foram removidos ${deleted.count} anúncios de teste.`);

  // 2. Resetar seedControl.json
  const resetData = {
    seed: SEED_TAG,
