...
async function main() {
  const tenantId = '893f640e-5bb8-4228-86d7-e075841e21b0'; // test_profile
  ...
  const company = await prisma.company.upsert({
    ...
    create: {
      ...
      slug: 'empresa-validacao-teste',
      description: 'Empresa criada para fins de validação técnica do sistema.',
    }
  });
  ...
  const otherCompany = await prisma.company.upsert({
    ...
    create: {
      ...
      slug: 'empresa-isolamento-teste',
      description: 'Empresa de outro tenant para testar isolamento.',
    }
  });
