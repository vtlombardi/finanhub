...
-- CreateEnum
CREATE TYPE "PlanTier" AS ENUM ('BASE', 'PROFESSIONAL', 'ELITE', 'FREE', 'BASIC', 'PRO', 'ENTERPRISE', 'ESSENTIAL', 'PREMIUM', 'BUSINESS', 'CORPORATE_ELITE');
...
-- CreateIndex
CREATE INDEX "DataRoomDocument_listingId_idx" ON "DataRoomDocument"("listingId");

-- CreateIndex
CREATE INDEX "DataRoomRequest_tenantId_status_idx" ON "DataRoomRequest"("tenantId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "DataRoomRequest_listingId_investorId_key" ON "DataRoomRequest"("listingId", "investorId");
...
-- AddForeignKey
ALTER TABLE "DataRoomDocument" ADD CONSTRAINT "DataRoomDocument_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DataRoomRequest" ADD CONSTRAINT "DataRoomRequest_investorId_fkey" FOREIGN KEY ("investorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DataRoomRequest" ADD CONSTRAINT "DataRoomRequest_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
